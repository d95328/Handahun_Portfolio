...
public class BoardLatelyListAdapter extends RecyclerView.Adapter<BoardLatelyListAdapter.ViewHolder> {

    private final List<Board> mDataList;
    private RecyclerViewClickListener mListener;
    private RequestManager requestManager;

    public BoardLatelyListAdapter(List<Board> mDataList, RequestManager requestManager) {
    ...
    @NonNull
    @Override
    public BoardLatelyListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
