...
public class AsyncMarkerLoad extends AsyncTask<String, Void, ArrayList<Board>> {
    ...
    public AsyncMarkerLoad(Activity activity) {
    ...
    protected ArrayList<Board> doInBackground(String... params) {
        ...
        try {
            String jsonPage = getStringFromUrl(params[0],params[1],params[2]);
    ...
    public String getStringFromUrl (String mUrl, String latitude, String longitude){
        //2byte 처리. 문자열 처리.
        ...
        try {
            ...
            jsonObject.put("b_latitude", latitude);
            jsonObject.put("b_longitude", longitude);
