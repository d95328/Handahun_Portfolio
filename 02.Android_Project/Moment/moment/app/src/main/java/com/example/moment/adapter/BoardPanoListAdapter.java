...
public class BoardPanoListAdapter extends RecyclerView.Adapter<BoardPanoListAdapter.ViewHolder> {

    private final List<Board> mDataList;
    private RecyclerViewClickListener mListener;
    private RequestManager requestManager;

    public BoardPanoListAdapter(List<Board> mDataList, RequestManager requestManager) {
    ...
    @NonNull
    @Override
    public BoardPanoListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
