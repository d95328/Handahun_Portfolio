...
public class BoardSearchListAdapter extends RecyclerView.Adapter<BoardSearchListAdapter.ViewHolder> {

    private final List<Board> mDataList;
    private RecyclerViewClickListener mListener;

    public BoardSearchListAdapter(List<Board> mDataList) {
        this.mDataList = mDataList;
        Log.i("Adapter input Data >>> ", mDataList.toString());
    }

    @NonNull
    @Override
    public BoardSearchListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.items_board_cardviewlist, parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BoardSearchListAdapter.ViewHolder holder, int position) {
