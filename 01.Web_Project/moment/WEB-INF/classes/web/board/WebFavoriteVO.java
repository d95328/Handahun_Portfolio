...
public class WebFavoriteVO {
	...
	public WebFavoriteVO() {}
	
	public WebFavoriteVO(String f_userid, int f_bno, String f_favorites, String f_ddabong) {
		super();
	...
	public String toString() {
		return "WebFavoriteVO [f_userid=" + f_userid + ", f_bno=" + f_bno + ", f_favorites=" + f_favorites
				+ ", f_ddabong=" + f_ddabong + "]";
	}
