...
.topMenu {font-family: 'Noto Serif KR', serif !important;}
...
<nav id="topMenu">
     <ul>
        ...
        <li><a class="menuLink" href="myfavorite.moment" style= "font-weight:bold; color: #f56437fa;"> 즐겨찾기 </a></li>                     
     </ul>
</nav>
<div class="contentbody" style="padding-top:50px;">	
	...
	<div id="data-list" style="clear:both;" >
		...
		<c:forEach items="${page.list}" var="vo">	
			<li>
				<div></div>					
				<div style="padding:0; width:100%; padding-top:10px;"><a onclick="detail(${vo.b_no}, '${login_info.u_userid}')" ><img src="img/background/${vo.b_imgpath}" style="width:100%; height:100%;"></a></div>			
				<div style="padding:5px; height:10px;"><a style="font-weight: bold;" onclick="detail(${vo.b_no}, '${login_info.u_userid}')">${vo.b_title}</a></div>
	 ...
	 <form method="post" action="myfavorite.moment">
		<input type="hidden" name="curPage" value="1"/>
	  	<div class="top" style="background-color: black; float:right; padding-top: 30px">
			...
			<input type="text" id="searchinput" name='keyword' style="color: white;" value="${page.keyword}"/>
